...
func newTester(light bool) *fetcherTester {
	...
	tester.fetcher = NewBlockFetcher(light, false, tester.getHeader, tester.getBlock, tester.verifyHeader, tester.broadcastBlock, tester.chainHeight, tester.insertHeaders, tester.insertChain, tester.dropPeer)
